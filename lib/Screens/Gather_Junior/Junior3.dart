...
class Junior3 extends StatefulWidget {
  const Junior3({super.key});

  @override
  _WikipediaExplorerState createState() => _WikipediaExplorerState();
}

class _WikipediaExplorerState extends State<Junior3> {
  @override
  void initState() {
    super.initState();
        ...
        body: SafeArea(
          child: InAppWebView(
            initialUrlRequest: URLRequest(
              url: Uri.parse(
                "https://meet.jit.si/EnglishSpokenCafeJunior3Gather",
              ),
            ),
