...
class speakcant extends StatefulWidget {
  const speakcant({super.key});

  @override
  _WikipediaExplorerState createState() => _WikipediaExplorerState();
}

class _WikipediaExplorerState extends State<speakcant> {
  @override
  void initState() {
    super.initState();
        ...
        body: SafeArea(
          child: InAppWebView(
            initialUrlRequest: URLRequest(
              url: Uri.parse(
                "https://meet.jit.si/EnglishSpokenCafeIcanSpeakGather",
              ),
            ),
