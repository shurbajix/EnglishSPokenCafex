...
class speakcanfluntly extends StatefulWidget {
  const speakcanfluntly({super.key});

  @override
  _WikipediaExplorerState createState() => _WikipediaExplorerState();
}

class _WikipediaExplorerState extends State<speakcanfluntly> {
  @override
  void initState() {
    super.initState();
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('I can speak fluently'),
          centerTitle: true,
        ),
        body: SafeArea(
          child: InAppWebView(
            initialUrlRequest: URLRequest(
              url: Uri.parse(
                  "https://meet.jit.si/EnglishSpokenCafeIcanSpeakFluentlyGather"),
            ),
